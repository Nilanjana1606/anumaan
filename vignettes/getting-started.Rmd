...
data <- prep_standardize_sex(data, sex_col = "gender")
...
cleaned <- prep_clean_ast_values(ast_data, ast_col = "antibiotic_value")
cleaned
```
...
get_antimicrobial_categories("Enterobacterales")
...
```{r plot-daly}
plot_burden_comparison(hospital_daly, metric = "DALY")
plot_daly_lollipop(hospital_daly, type = "attributable")
plot_resistance_fraction(hospital_daly)
plot_gbd_fig4(hospital_daly)
```
